...
const NavBar = () => {
  return (
    <div className="text-xl sm:text-2xl xl:text-3xl 2xl:text-4xl text-cyan-400">
      ...
      <div className="z-10 fixed gap-2 flex sm:left-0 sm:-translate-x-[40%] sm:top-[50%] sm:-translate-y-[50%] sm:border-b-0 bg-white bg-opacity-10 p-2 sm:rounded-t-md sm:border-[0.1px] border-cyan-300 sm:rotate-90 top-0 left-[50%] -translate-x-[50%] border-t-0 rounded-b-md border-[0.1px]">
        <FileDownloadIcon />
        <span className="text-sm sm:text-base md:text-lg xl:text-2xl 2xl:text-3xl">Download CV</span>
      </div>
    </div>
  );
};
